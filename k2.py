...
plt.title('Training Loss vs Epochs (c1k2)', fontsize=14)
...
plt.title('Validation Accuracy vs Epochs (c1k2)', fontsize=14)
plt.grid(True, alpha=0.3)
plt.tight_layout()
...
with open(report_path, "w") as f:
    f.write("Classification Report - Test Set (c1k2)\n")
    f.write("=" * 80 + "\n\n")
    f.write(report)
...
plt.title('Confusion Matrix Heatmap - Test Set (c1k2)', fontsize=15, fontweight='bold', pad=20)
